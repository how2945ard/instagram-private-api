...
exports.credentials = function () {
  ...
  if (_.isString(credentials[0]) && _.isString(credentials[1])) return Promise.resolve(credentials);
  return new Promise(((resolve, reject) => inquirer.prompt(askCredentialsSchema)
    .then((answers) => {
