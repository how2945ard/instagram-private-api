...
function Device(username) {
  if (!_.isString(username)) throw new Error('`Device` class needs username to be able generate correlated phone_id seed!');
...
Object.defineProperty(Device.prototype, 'release', {
  get() {
    if (!this._release) this._release = ['4.0.4', '4.3.1', '4.4.4', '5.1.1', '6.0.1'][this.md5int % 5];
...
Object.defineProperty(Device.prototype, 'dpi', {
  get() {
    if (!this._dpi) this._dpi = ['801', '577', '576', '538', '515', '424', '401', '373'][this.md5int % 8];
    return this._dpi;
  },
  set(set) {
...
Device.prototype.userAgent = function (version) {
  const agent = [`${this.api}/${this.release}`, `${this.dpi}dpi`,
